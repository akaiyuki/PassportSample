...
class Packages extends CI_Controller {
	...
	public function index()
	{
		...
		$this->load->view('packages/packages', $this->packages_model->view());
...
//			$_POST['prettyName'] = str_replace(' ','-', $_POST['prettyName']);
			$this->load->model('packages_model');
			$this->packages_model->edit($id, $_POST);
		}
		$data['id'] = $id;
		$this->load->model('packages_model');
		$data['packages'] = $this->packages_model->get_id($id); 
