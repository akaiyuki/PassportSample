            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <!-- Financial Tables -->
                        <li>
                            <a href="#financial-table"><i class="fa fa-money fa-fw"></i> Financial Tables<span class="fa arrow"></a>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?php echo base_url(); ?>carmakes/">View All</a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url(); ?>carmakes/add/">Add</a>
                                </li>
                            </ul>
                        </li>
                        <!-- CarTypes -->
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?php echo base_url(); ?>cartypes/">View All</a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url(); ?>cartypes/add/">Add</a>
                                </li>
                            </ul>
                        </li>
                        <!-- CarModels -->
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?php echo base_url(); ?>carmodels/">View All</a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url(); ?>carmodels/add/">Add</a>
                                </li>
                            </ul>
                        </li>
                        <!-- Excess Nav 
